...
import { CheckCircle2, FileText, Zap, Shield, ArrowRight, Menu, X, Play, BarChart3, Clock, Check, FileSearch, Send } from 'lucide-react';
      ...
      <section id="how-it-works" className="py-24 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-slate-400">Streamline your bidding process in three simple steps.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-12 relative">
            {/* Connecting lines for desktop */}
            <div className="hidden md:block absolute top-12 left-1/6 right-1/6 h-0.5 bg-slate-800 z-0 border-t-2 border-dashed border-slate-700 w-2/3 mx-auto"></div>

            <div className="relative z-10 flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-[#002b5b] rounded-full flex items-center justify-center border-4 border-slate-900 shadow-xl mb-6 text-white text-3xl font-bold">
                1
              </div>
              <h3 className="text-xl font-bold mb-4">Set up Business Profile</h3>
              <p className="text-slate-400">Enter your company details, GST, turnover, ISO certifications, and upload your custom letterhead once.</p>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-4">Upload Tender PDF</h3>
              <p className="text-slate-400">Upload any government or private NIT. The AI engine instantly parses eligibility criteria, timelines, and EMD.</p>
            </div>

            <div className="relative z-10 flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-emerald-600 rounded-full flex items-center justify-center border-4 border-slate-900 shadow-xl mb-6 text-white text-3xl font-bold">
                <CheckCircle2 className="w-10 h-10" />
              </div>
              <h3 className="text-xl font-bold mb-4">Export & Bid</h3>
              <p className="text-slate-400">Review the auto-generated technical bid annexures and print them perfectly formatted on your letterhead.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm flex flex-col">
              ...
              <p className="text-slate-500 mt-2">Perfect for exploring the platform.</p>
              ...
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex gap-3 text-slate-600"><Check className="w-5 h-5 text-emerald-500 shrink-0" /> Up to 3 Tender Analyses / month</li>
                <li className="flex gap-3 text-slate-600"><Check className="w-5 h-5 text-emerald-500 shrink-0" /> Basic PDF Data Extraction</li>
                <li className="flex gap-3 text-slate-600"><Check className="w-5 h-5 text-emerald-500 shrink-0" /> Standard Support</li>
              ...
              {user ? (
                <Link to="/dashboard" className="w-full py-4 rounded-xl font-bold text-center border-2 border-slate-200 text-slate-600 hover:bg-slate-50 transition-all block">
                  Current Plan
                </Link>
              ) : (
                <Link to="/login" className="w-full py-4 rounded-xl font-bold text-center border-2 border-slate-200 text-slate-600 hover:bg-slate-50 transition-all block">
                  Get Started Free
                </Link>
              )}
            </div>
            ...
            {/* Pro Plan (Quarterly) */}
            <div className="bg-white rounded-3xl p-8 border-2 border-[#002b5b] shadow-xl flex flex-col relative transform md:-translate-y-4">
              <div className="absolute top-0 right-8 transform -translate-y-1/2 bg-[#002b5b] text-white px-3 py-1 rounded-full text-sm font-bold shadow-md">
                Quarterly
              </div>
              <h3 className="text-2xl font-bold text-slate-900">Pro</h3>
              <p className="text-slate-500 mt-2">For active contractors bidding regularly.</p>
              <div className="mt-6 mb-8">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex gap-3 text-slate-600"><Check className="w-5 h-5 text-emerald-500 shrink-0" /> Unlimited Tender Analyses</li>
            ...
            <div className="bg-[#002b5b] rounded-3xl p-8 border border-[#001f42] shadow-2xl flex flex-col relative">
              <div className="absolute top-0 right-8 transform -translate-y-1/2 bg-gradient-to-r from-amber-400 to-orange-500 text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg">
                Best Value
              </div>
              <h3 className="text-2xl font-bold text-white">Enterprise</h3>
              <p className="text-blue-200 mt-2">Maximum value for serious infrastructure firms.</p>
              <div className="mt-6 mb-8">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex gap-3 text-white"><Check className="w-5 h-5 text-emerald-400 shrink-0" /> <strong>All Pro Features</strong></li>
                <li className="flex gap-3 text-white"><Check className="w-5 h-5 text-emerald-400 shrink-0" /> Priority 24/7 Support</li>
                <li className="flex gap-3 text-white"><Check className="w-5 h-5 text-emerald-400 shrink-0" /> Early Access to New Features</li>
                <li className="flex gap-3 text-white"><Check className="w-5 h-5 text-emerald-400 shrink-0" /> Bulk Tender Processing (Coming Soon)</li>
                <li className="flex gap-3 text-white"><Check className="w-5 h-5 text-emerald-400 shrink-0" /> Save ₹1,997 annually vs Pro</li>
              </ul>
